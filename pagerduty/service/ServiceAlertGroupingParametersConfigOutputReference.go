...
func (s *jsiiProxy_ServiceAlertGroupingParametersConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceAlertGroupingParametersConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
