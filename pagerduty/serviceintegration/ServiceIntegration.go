...
func ServiceIntegration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceIntegration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
