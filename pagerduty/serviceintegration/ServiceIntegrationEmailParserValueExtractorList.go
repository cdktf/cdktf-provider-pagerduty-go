...
func (s *jsiiProxy_ServiceIntegrationEmailParserValueExtractorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceIntegrationEmailParserValueExtractorList) Resolve(context cdktf.IResolveContext) interface{} {
