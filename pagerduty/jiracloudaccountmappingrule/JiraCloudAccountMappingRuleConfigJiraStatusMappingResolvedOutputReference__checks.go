...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraStatusMappingResolvedOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraStatusMappingResolvedOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *JiraCloudAccountMappingRuleConfigJiraStatusMappingResolved; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraStatusMappingResolvedOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewJiraCloudAccountMappingRuleConfigJiraStatusMappingResolvedOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
