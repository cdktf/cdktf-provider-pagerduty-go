...
func (r *jsiiProxy_RulesetRuleActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RulesetRuleActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
