...
func (j *jsiiProxy_SlackConnectionConfigAOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSlackConnectionConfigAOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SlackConnectionConfigAOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-pagerduty.slackConnection.SlackConnectionConfigAOutputReference",
...
func NewSlackConnectionConfigAOutputReference_Override(s SlackConnectionConfigAOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (s *jsiiProxy_SlackConnectionConfigAOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SlackConnectionConfigAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SlackConnectionConfigAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
