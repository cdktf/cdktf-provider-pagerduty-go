...
func (s *jsiiProxy_ServiceDependencyDependencyDependentServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceDependencyDependencyDependentServiceList) Resolve(context cdktf.IResolveContext) interface{} {
