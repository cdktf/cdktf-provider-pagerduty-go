...
func (s *jsiiProxy_ServiceDependencyDependencySupportingServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceDependencyDependencySupportingServiceList) Resolve(context cdktf.IResolveContext) interface{} {
