...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v13/teammembership/internal"
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.1/docs/resources/team_membership pagerduty_team_membership} Resource.
func NewTeamMembership(scope constructs.Construct, id *string, config *TeamMembershipConfig) TeamMembership {
	...
	_jsii_.Create(
		"@cdktf/provider-pagerduty.teamMembership.TeamMembership",
