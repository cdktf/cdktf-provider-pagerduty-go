...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v13/user/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.5/docs/resources/user pagerduty_user}.
type User interface {
	...
	SetId(val *string)
	IdInput() *string
	InvitationSent() cdktf.IResolvable
	JobTitle() *string
...
func (j *jsiiProxy_User) InvitationSent() cdktf.IResolvable {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.5/docs/resources/user pagerduty_user} Resource.
