...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v4/datapagerdutyautomationactionsaction/internal"
...
func (j *jsiiProxy_DataPagerdutyAutomationActionsAction) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataPagerdutyAutomationActionsAction)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
