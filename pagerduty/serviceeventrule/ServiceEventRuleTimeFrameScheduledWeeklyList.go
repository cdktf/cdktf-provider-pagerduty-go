...
func (s *jsiiProxy_ServiceEventRuleTimeFrameScheduledWeeklyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceEventRuleTimeFrameScheduledWeeklyList) Resolve(context cdktf.IResolveContext) interface{} {
