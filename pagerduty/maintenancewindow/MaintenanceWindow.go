...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v13/maintenancewindow/internal"
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.12.1/docs/resources/maintenance_window pagerduty_maintenance_window} Resource.
func NewMaintenanceWindow(scope constructs.Construct, id *string, config *MaintenanceWindowConfig) MaintenanceWindow {
	...
	_jsii_.Create(
		"@cdktf/provider-pagerduty.maintenanceWindow.MaintenanceWindow",
