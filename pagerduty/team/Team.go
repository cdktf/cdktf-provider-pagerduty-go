...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v13/team/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.0/docs/resources/team pagerduty_team}.
type Team interface {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.0/docs/resources/team pagerduty_team} Resource.
func NewTeam(scope constructs.Construct, id *string, config *TeamConfig) Team {
	...
	_jsii_.Create(
		"@cdktf/provider-pagerduty.team.Team",
