...
func (j *jsiiProxy_Schedule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Schedule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Schedule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func Schedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_Schedule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Schedule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_Schedule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
