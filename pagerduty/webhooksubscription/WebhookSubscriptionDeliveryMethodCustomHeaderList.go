...
func (w *jsiiProxy_WebhookSubscriptionDeliveryMethodCustomHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebhookSubscriptionDeliveryMethodCustomHeaderList) Resolve(context cdktf.IResolveContext) interface{} {
