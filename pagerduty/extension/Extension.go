...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14/extension/internal"
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.28.0/docs/resources/extension pagerduty_extension} Resource.
func NewExtension(scope constructs.Construct, id *string, config *ExtensionConfig) Extension {
	...
	_jsii_.Create(
		"@cdktf/provider-pagerduty.extension.Extension",
