...
import (
	...
	"github.com/hashicorp/cdktf-provider-pagerduty-go/pagerduty/v3/datapagerdutyextensionschema/internal"
...
func (j *jsiiProxy_DataPagerdutyExtensionSchema) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
