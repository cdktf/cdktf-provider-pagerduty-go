...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v4/incidentworkflowtrigger/internal"
...
func (j *jsiiProxy_IncidentWorkflowTrigger) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IncidentWorkflowTrigger)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
