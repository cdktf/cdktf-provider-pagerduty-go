...
func (e *jsiiProxy_EventOrchestrationGlobalSetRuleActionsVariableList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventOrchestrationGlobalSetRuleActionsVariableList) Resolve(context cdktf.IResolveContext) interface{} {
