...
func (e *jsiiProxy_EventOrchestrationGlobalCatchAllActionsAutomationActionParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventOrchestrationGlobalCatchAllActionsAutomationActionParameterList) Resolve(context cdktf.IResolveContext) interface{} {
