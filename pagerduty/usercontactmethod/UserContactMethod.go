...
import (
	...
	"github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v13/usercontactmethod/internal"
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.12.1/docs/resources/user_contact_method pagerduty_user_contact_method} Resource.
...
func UserContactMethod_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (u *jsiiProxy_UserContactMethod) ImportFrom(id *string, provider cdktf.TerraformProvider) {
