...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.11.4/docs/resources/ruleset pagerduty_ruleset} Resource.
func NewRuleset(scope constructs.Construct, id *string, config *RulesetConfig) Ruleset {
	...
	_jsii_.Create(
		"@cdktf/provider-pagerduty.ruleset.Ruleset",
